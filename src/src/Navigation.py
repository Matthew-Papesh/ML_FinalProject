...
class Navigation: 
    ...
    def splineDrive(self, spline_path: Path, spline_sd_steps: list, spline_cumulative_sd_steps: list, acceleration: float, max_linear_speed: float, max_angular_speed: float, max_centripetal_acceleration: float) -> tuple[Path, list, list, list, list, list, list, list, list, list]:
        """
    ...
    def driveSplinePath(self, waypoints: list, acceleration: float, max_linear_speed: float, max_angular_speed: float, max_centripetal_acceleration: float) -> tuple[Path, list, list, list, list, list, list, list]:
        ...
        recorded_path, recorded_speeds, ideal_speeds, x_errors, y_errors, heading_errors, lin_speeds, ang_speeds, lin_adjs, ang_adjs = self.splineDrive(spline_plan[0], spline_plan[1], spline_plan[2], acceleration, max_linear_speed, max_angular_speed, max_centripetal_acceleration)
        # return results
    ...
    def handleSimulationTestService(self, request):
        ...
        # run test
        x_errors, y_errors, heading_errors, lin_speeds, ang_speeds, lin_adjs, ang_adjs  = self.test()
        return GetNavSimTestResponse(x_errors=x_errors, y_errors=y_errors, heading_errors=heading_errors, lin_speeds=lin_speeds, ang_speeds=ang_speeds, lin_speed_adjs=lin_adjs, ang_speed_adjs=ang_adjs)
    ...
    def test(self) -> tuple[list, list, list, list, list]:
        ...
        return (x_errors, y_errors, heading_errors, lin_speeds, ang_speeds, lin_adjs, ang_adjs)
